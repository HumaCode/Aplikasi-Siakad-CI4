                    ...
                    <tbody>
                        ...
                        foreach ($ta as $g) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?= $g['ta'] ?></td>
                                <td class="text-center"><?= $g['semester'] ?></td>
                                <td class="text-center"><?= ($g['status'] == 0) ? '<span class="label label-danger">Tidak Aktif</span>' : '<span class="label label-success">Aktif</span>' ?></td>
                                <td class="text-center">
                                    <?php if ($g['status'] == 0) { ?>
                                        <a href="<?= base_url('ta/setStatusTa/' . $g['id_ta']) ?>" class="btn btn-sm btn-success"><i class="fa fa-check"></i> &nbsp;Aktifkan</a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php $i++;
